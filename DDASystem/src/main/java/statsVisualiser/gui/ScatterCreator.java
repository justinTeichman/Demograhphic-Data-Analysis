 ...
 */
public class ScatterCreator extends Creator {
	
	/**
	 * This method implements the makeViewer() method by creating and returning
	 * and instance of the ScatterChart Viewer.
	 * 
	 * @return An instance of the ScatterChart Viewer class.
	 */
	public Viewer makeViewer()
	{
		return ScatterChart.getInstance();
	}
}
